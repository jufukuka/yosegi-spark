...
public class SparkSequentialBooleanLoader extends AbstractSparkSequentialLoader {
  ...
  public SparkSequentialBooleanLoader(WritableColumnVector vector, int loadSize, int totalChildCount, int currentChildCount) {
  ...
  public void setBoolean(int index, boolean value) throws IOException {
    vector.putBoolean(getIndex(index), value);
  }
