...
import jp.co.yahoo.yosegi.spark.inmemory.loader.map.SparkMapChildSequentialDoubleLoader;
import org.apache.spark.sql.execution.vectorized.WritableColumnVector;

import java.io.IOException;

public class SparkMapChildDoubleLoaderFactory extends AbstractSparkMapChildLoaderFactory {
  public SparkMapChildDoubleLoaderFactory(
  ...
  public ILoader createLoader(ColumnBinary columnBinary, int loadSize) throws IOException {
    ...
    switch (getLoadType(columnBinary, loadSize)) {
      case SEQUENTIAL:
        return new SparkMapChildSequentialDoubleLoader(
