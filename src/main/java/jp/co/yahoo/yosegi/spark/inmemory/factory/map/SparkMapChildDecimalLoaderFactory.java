...
import jp.co.yahoo.yosegi.spark.inmemory.loader.map.SparkMapChildSequentialDecimalLoader;
import org.apache.spark.sql.execution.vectorized.WritableColumnVector;

import java.io.IOException;

public class SparkMapChildDecimalLoaderFactory extends AbstractSparkMapChildLoaderFactory {
  public SparkMapChildDecimalLoaderFactory(
  ...
  public ILoader createLoader(ColumnBinary columnBinary, int loadSize) throws IOException {
    ...
    switch (getLoadType(columnBinary, loadSize)) {
      case SEQUENTIAL:
        return new SparkMapChildSequentialDecimalLoader(
