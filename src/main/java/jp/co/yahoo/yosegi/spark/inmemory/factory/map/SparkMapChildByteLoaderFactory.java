...
public class SparkMapChildByteLoaderFactory extends AbstractSparkMapChildLoaderFactory {
  public SparkMapChildByteLoaderFactory(WritableColumnVector vector, int totalChildCount, int currentChildCount) {
